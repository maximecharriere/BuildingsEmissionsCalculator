---
title: "Calculateur de CO2 SIA 380/1"
output: rmarkdown::html_vignette
vignette: >
  %\VignetteIndexEntry{Calculateur de CO2 SIA 380/1}
...
In the norm SIA 380/1:2009 "Thermische Energie im Hochbau", the calculation of the carbon dioxide (CO2) emission of a building is given. Wüest Partner provided the code implementing this calculation in the R package `co2calculatorPACTA2022`. We included this code in our package `BuildingsEmissionsCalculator`.  
...
Pour l'ouvrir en grand: [sia_calculator_steps.svg](img/sia_calculator_steps.svg)

![Figure 1 : Diagramme d'architecture du script](img/sia_calculator_steps.svg)
